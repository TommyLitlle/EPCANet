...
def fu_resnet18(pretrained=False, **kwargs):
    model = ResidualNet("ImageNet", 18, 5, 'CBAM')
    return model

def fu_resnet34(pretrained=False, **kwargs):
    model = ResidualNet("CIFAR100", 34, 5, 'CBAM')
    return model

def fu_resnet50(pretrained=False, **kwargs):
    model = ResidualNet("ImageNet", 50, 2, 'CBAM')
    return model

def fu_resnet101(pretrained=False, **kwargs):
