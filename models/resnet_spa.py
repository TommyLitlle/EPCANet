...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.se  = SPALayer(planes * self.expansion)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.stride = stride
...
def spa_resnet18(pretrained=False, **kwargs):
...
def spa_resnet34(pretrained=False, **kwargs):
...
def spa_resnet50(pretrained=False, **kwargs):
...
def spa_resnet101(pretrained=False, **kwargs):
