...
class PAM_Module(nn.Module):
    ...
    def __init__(self, in_dim):
        ...
        self.query_conv = nn.Conv2d(in_channels=1, out_channels=in_dim//16, kernel_size=1)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,use_da=None):
        ...
        self.se  = DAModule(planes*self.expansion)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.stride = stride
        self.da = use_da
...
def msa_resnet18(pretrained=False, **kwargs):
...
def msa_resnet34(pretrained=False, **kwargs):
...
def msa_resnet50(pretrained=False, **kwargs):
...
def msa_resnet101(pretrained=False, **kwargs):
...
def msa_resnet152(pretrained=False, **kwargs):
